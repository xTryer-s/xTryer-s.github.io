...
- Introduced a lightweight multimodal style adapter
- Proposed post-training refinement pipeline including LoRA-based NFA and GRPO-based SE for font generation
